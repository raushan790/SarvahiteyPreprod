...
(function() {
    ...
    function initialize() {
        ...
        var map_options = {
            center: new google.maps.LatLng(28.582665, 77.37257),
            zoom: 15,
    ...
    var myLatlng = new google.maps.LatLng(28.582665, 77.37257); // New York
    function init() {
        ...
        var contentString = '<div id="">' +
            ...
            '<h4><i class="fa fa-car text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>F 56, Sector 51, Noida, 201301</b></h4>' +
            '<h4><i class="fa fa-envelope text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>sarvahitey@gmail.com</b></h4>' +
            '<h4><i class="fa fa-send text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>+91 8285 423 423</b></h4><br>' +
            '<p>Interested in volunteering?<br>Just want to chat about an idea? We would love to hear from you.</p>' +
            '</div>' +
            '</div>';
